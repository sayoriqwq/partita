...
| pm:notate | Use when creating a new Partita primitive skill or re-founding a broken skill from a behavior motif into a legal source projection. Not for local retuning of an existing skill, installing skills, ordinary docs, or verifier implementation. | `skills/primitive/notate/SKILL.md` |
| pm:retune | Use when an existing Partita skill needs a local correction from a real behavior case or structure audit. Not for creating a new skill, re-founding a broken primitive, ordinary code review, prose cleanup, or hard verifier/schema work. | `skills/primitive/retune/SKILL.md` |
