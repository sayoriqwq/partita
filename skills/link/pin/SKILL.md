...
- Filesystem: MAY 在批准 scope 内写入 `repos/<name>.subtree.json` 或由 owning command materialize 的 pinned prefix；MUST NOT 手工复制外部 source 来绕过 command。
