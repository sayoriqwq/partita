...
The user's observed case is the source situation. Preserve the behavior shape
that lets the next agent recognize the same default failure.
...
- Do not put long concrete cases in the target `SKILL.md` every-run body.
