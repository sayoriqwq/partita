...
| Notate a primitive skill | `wiki/practice/create.md` | `skills/primitive/<name>/SKILL.md`, `skills/primitive/<name>/agents/openai.yaml` | `pnpm generate`, `pnpm verify` |
| Retune a skill | `wiki/practice/patch.md` | target skill files and direct references | `pnpm generate`, `pnpm verify` |
